...
class ZIMKitCustomControls extends StatefulWidget {
  ...
  State<StatefulWidget> createState() {
    return _ZIMKitCustomControlsState();
  }
}

class _ZIMKitCustomControlsState extends State<ZIMKitCustomControls>
  ...
  Widget _buildOptionsButton({
    ...
    return AnimatedOpacity(
      ...
      child: IconButton(
        padding: isPadded ? EdgeInsets.all(8.zR) : EdgeInsets.zero,
        onPressed: () async {
          _hideTimer?.cancel();
    ...
    return AnimatedOpacity(
      ...
      child: Container(
        ...
        padding: EdgeInsets.only(
            bottom: (chewieController.isFullScreen ? 10.0 : 15.0).zH),
        child: SafeArea(
                ...
                child: Row(
                  children: <Widget>[
                    ...
                    if (chewieController.isLive)
                      Expanded(
                          child: Text(ZIMKitCore.instance.innerText.liveText))
                    else
